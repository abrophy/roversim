...
Gem::Specification.new do |spec|
  ...
  spec.description   = 'Roversim is a commandline ruby gem for predicting '\
    'location of a simulated rover based on input from file'
  ...
  spec.executables   = ['roversim_abrophy.rb']
